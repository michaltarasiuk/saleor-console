...
const productThumbnail = cva(
  "rounded-base border-base-border bg-base-background-subdued relative flex items-center justify-center overflow-hidden border",
  {
    variants: {
      size: {
        small: "size-10",
...
export function ProductThumbnail({
  ...
  return (
    <div className={cn("relative")}>
      ...
      <div
        className={cn("absolute end-0 top-0 translate-x-1/2 -translate-y-1/2")}>
